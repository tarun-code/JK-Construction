            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="box-link"><a href="manage_product.php">Add Properties</a> </h4>
                    </div>
                    <div class="card-body--">
                        <div class="table-stats order-table ov-h">
                            <table class="table ">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="7%">Price persq.ft</th>
                                        <th width="10%">Property ameneties</th>
                                        <th width="10%">Rera no</th>
                                        <th width="10%">Rera</th>
                                        <th width="10%">Construction status</th>
                                        <th width="10%">Possession start</th>
							...
							while($row=mysqli_fetch_assoc($res)){?>
                                    <tr>
                                        ...
                                        <td><?php echo $row['pricesq']?></td>
                                        <td><?php echo $row['project_ameneties']?></td>
                                        <td><?php echo $row['rera_no']?></td>
                                        <td><?php echo $row['rera']?></td>
                                        <td><?php echo $row['construction_status']?></td>
                                        <td><?php echo $row['possession_start']?></td>
