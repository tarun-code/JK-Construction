...
echo "<a target='_blank' href='".BLOG_SITE_PATH.$row['image']."'><img width='150px' src='".BLOG_SITE_PATH.$row['image']."'/></a>";
							   ?>
                                        </td>
								...
								echo "<span class='badge badge-edit'><a href='manage_blog.php?id=".$row['id']."'>Edit</a></span>&nbsp;";
